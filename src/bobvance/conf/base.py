...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "bobvance.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "bobvance.wsgi.application"
...
DEFAULT_FROM_EMAIL = "bobvance@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "bobvance.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "bobvance.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "bobvance_sessionid"
...
CSRF_FAILURE_VIEW = "bobvance.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "bobvance.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"bobvance {ENVIRONMENT}",
