...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-ota7^g=v=5wd3w&!^t#43#^_3xswkqc7f&$2in+lbwf$g^s9ve",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "bobvance")
os.environ.setdefault("DB_USER", "bobvance")
os.environ.setdefault("DB_PASSWORD", "bobvance")
